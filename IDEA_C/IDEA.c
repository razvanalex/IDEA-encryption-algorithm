...
void convertStringToBin(char *str, uint16_t *data, uint16_t size)
{
	...
	for (i = 0; i < strlen(str) && i < size * sizeof(uint16_t); i += sizeof(uint16_t)) 
	{
...
int main()
{
	char Data[64] = "0000010100110010000010100110010000010100110010000001100111111010";
	char Key[128] = "00000000011001000000000011001000000000010010110000000001100100000000000111110100000000100101100000000010101111000000001100100000";
